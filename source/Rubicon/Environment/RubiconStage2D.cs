...
[GlobalClass] public partial class RubiconStage2D : Node2D
{
    /// <summary>
    /// The initial position the camera should start at.
    /// </summary>
    [Export] public RubiconCameraPointReference2D InitialFocus;
    
    /// <summary>
    /// A list of defined spawn points to use when spawning in characters.
    /// </summary>
    [Export] public RubiconCharacterSpawnPoint2D[] SpawnPoints = [];
    
    /// <summary>
    /// Defined camera points to use alongside <see cref="RubiconEnvironmentSpace.FocusOnStagePoint"/>.
    /// </summary>
    [Export] public Dictionary<StringName, RubiconCameraPointReference2D> CameraPoints = [];

    /// <summary>
    /// An optional node for the camera to parent.
    /// </summary>
    [ExportGroup("Extras"), Export] public Node2D CameraParent;
    ...
    public RubiconCharacterSpawnPoint2D GetSpawnPointForNickname(StringName name)
    {
